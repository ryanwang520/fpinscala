...
trait Solver extends GameDef {
   ...
   */
  def done(b: Block): Boolean = this.goal == b.b1 && this.goal == b.b2
   ...
   */
  lazy val pathsFromStart: Stream[(Block, List[Move])] = from(Stream((this.startBlock, Nil)), Set[Block](this.startBlock))
